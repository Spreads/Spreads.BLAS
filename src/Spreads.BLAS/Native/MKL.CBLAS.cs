...
namespace Spreads.Native
{
    public static unsafe partial class MKL
    {
        public static class CBLAS
        {
            ...
            public static extern void Sgemv(BLAS.MatrixLayout matrixLayout, TransCblas TransA, int M, int N, float alpha, float* A, int lda, float* X, int incX, float beta, float* Y, int incY);
            ...
            public static extern void Dgemv(BLAS.MatrixLayout matrixLayout, TransCblas TransA, int M, int N, double alpha, double* A, int lda, double* X, int incX, double beta, double* Y, int incY);
            ...
            public static extern void Cgemv(BLAS.MatrixLayout matrixLayout, TransCblas TransA, int M, int N, IntPtr alpha, IntPtr A, int lda, IntPtr X, int incX, IntPtr beta, IntPtr Y, int incY);
            ...
            public static extern void Zgemv(BLAS.MatrixLayout matrixLayout, TransCblas TransA, int M, int N, IntPtr alpha, IntPtr A, int lda, IntPtr X, int incX, IntPtr beta, IntPtr Y, int incY);
            ...
            public static extern void Sgemmt(BLAS.MatrixLayout matrixLayout, UpLoCblas Uplo, TransCblas TransA, TransCblas TransB, int N, int K, float alpha, float* A, int lda, float* B, int ldb, float beta, float* C, int ldc);
            ...
            public static extern void Dgemmt(BLAS.MatrixLayout matrixLayout, UpLoCblas Uplo, TransCblas TransA, TransCblas TransB, int N, int K, double alpha, double* A, int lda, double* B, int ldb, double beta, double* C, int ldc);
            ...
            public static extern void Cgemmt(BLAS.MatrixLayout matrixLayout, UpLoCblas Uplo, TransCblas TransA, TransCblas TransB, int N, int K, IntPtr alpha, IntPtr A, int lda, IntPtr B, int ldb, IntPtr beta, IntPtr C, int ldc);
            ...
            public static extern void Zgemmt(BLAS.MatrixLayout matrixLayout, UpLoCblas Uplo, TransCblas TransA, TransCblas TransB, int N, int K, IntPtr alpha, IntPtr A, int lda, IntPtr B, int ldb, IntPtr beta, IntPtr C, int ldc);
